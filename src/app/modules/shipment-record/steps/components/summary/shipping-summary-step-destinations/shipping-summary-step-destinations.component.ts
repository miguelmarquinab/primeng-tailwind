...
@Component({
    ...
    standalone: true,
    imports: [DecimalPipe, ShippingSummaryStepHeaderComponent, ShippingSummaryStepTimelineMarkerComponent, CartItemCloneButtonComponent, CartItemDeleteButtonComponent],
